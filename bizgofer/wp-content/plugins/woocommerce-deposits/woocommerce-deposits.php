...
if( wc_deposits_woocommerce_is_active() ) :
	...
	class WC_Deposits{
		...
		private function __construct(){
			define( 'WC_DEPOSITS_VERSION' , '2.3.6' );
		 ...
		 function plugin_row_meta( $links, $file ) {
			...
			if ( $file === 'woocommerce-deposits/woocommerce-deposits.php' ) {
				...
				$row_meta =array(
				        ...
				        'documentation' => '<a  target="_blank" href="'.esc_url('https://woocommerce-deposits.webtomizer.com/documentation').'"> '.__('Documentation','woocommerce-deposits').'</a>',
