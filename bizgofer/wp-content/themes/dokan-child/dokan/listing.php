                ...
                foreach ($user_orders as $order) {
                    ...
                    <tr >
                        ...
                        <td class="dokan-order-status" data-title="<?php _e( 'Status', 'dokan-lite' ); ?>" >
                            <?php echo '<span class="dokan-label dokan-label-' . dokan_get_order_status_class( dokan_get_prop( $the_order, 'status' ) ) . '">' . biz_dokan_get_order_status_translated( dokan_get_prop( $the_order, 'status' ) ) . '</span>'; ?>
                        </td>
